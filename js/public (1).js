                                            ...
                                            if(itemsArray[i].node.inumber!= undefined ){
                                                ...
                                                layer.open({
                                                    ...
                                                    yes:function(index, layero){
                                                        ...
                                                        form.render();
                                                        if(currpre){
                                                            for(var k=0;k<currpre.length;k++){
                                                                console.log(itemsArray[currpre[k]-1]);
                                                                var p=itemsArray[currpre[k]-1].node;
                                                                if(p.inumber==curritem[0].inum){
                                                                    if(itemsArray[currpre[k]-1].node.next){
                                                                        itemsArray[currpre[k]-1].node=itemsArray[currpre[k]-1].node.next;
                                                                    }
                                                                    else {
                                                                        itemsArray[currpre[k]-1].node.inumber=undefined;
                                                                    }
                                                                }
                                                                else{
